...
6. iterate through each of the ordered list element in the result and add =usersSubject= in parenthesis if the first level list element does not have any related thing in the name, there is a example with machine learning user's subject.
